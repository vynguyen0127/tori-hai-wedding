 ...
 *   L  rsvp_submitted_at ISO timestamp
 */
...
const COL = {
  ...
  PLUS_ONE_ALLOWED:  9,
  PLUS_ONE_NAME:     10,
  RSVP_SUBMITTED_AT: 11,
};

// Column letters for write operations (A=0 … L=11)
...
export async function getAllGuests(forceRefresh = false) {
  ...
  const res = await sheets.spreadsheets.values.get({
    ...
    range: `${SHEET_NAME}!A2:L`, // Row 1 is headers
  });
 ...
 *   Array of { guestId, status, dietaryNotes, plusOneName }
 */
